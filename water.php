...
if(isset($_POST["submit"]))
{
    ...
    $EC = $_POST["Empty_Container"];
    $IT = $_POST["In_Time"];
    $image = $_POST["image1"];
    $image = "<img src = ".$image.">";
    $Security = $_POST["Security_Signature"];
    ...
    foreach($sql1 as $s)
{
    if(mysqli_query($conn,$s))
    {
        ...
        {        
                ...
                $sql = "insert into master(catergory,date1,Vehicle_Number,From_Address,Empty_Container,In_Time,Reciver_Signature,Security_Signature,Remarks,Token_Number) values('$cat','$date','$VN','$Add','$EC','$IT','$image','$Security','$Remarks','$Token');";
                ...
                if(mysqli_query($conn,$sql))
                    {
                        ...
                        $alert[]= $msg;
                        $alert[]= $msg2;
                        logEvent('----Water Form Session Over---');
                    }
                else{
...
<div class = "main"><hr>
    ...
    <tr><td colspan = "2" align = "center"><input type = "button" id = "btnAddCol" onclick="add()" value = "Add New Row"/></td></tr>
     <tr><td>Empty Container: </td><td> <input type="text" name="Empty_Container" /></td></tr>
 <tr>
