...
if(isset($_POST["submit"]))
    {
        ...
        if(count($alert)==0)
        {
                ...
                $sql = "insert into master(catergory,date1,Name,In_Time,Signature,Token_Number) values('$cat','$date','$name','$IT','$image','$Token');";
                ...
                if(mysqli_query($conn,$sql))
                    {
                        ...
                        $alert[]= $msg;
                        $alert[]= $msg2;
                        logEvent('----Holiday Security Attendance Form Session Over---');
                    }
                else{
...
<head>
    <meta charset="utf-8">
	<title>Holiday Security Attendance Form</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
<div class = "main"><hr>
    <?php logEvent('----Holiday Security Attendance Form Session Started---'); ?>
    <h1><b><i>Holiday Security Attendance Form</i></b></h1><hr>
    ...
    <form method = "POST" action = "security_on_holiday.php" autocomplete="off">
    <table> 
    ...
    <?php logEvent('Holiday Security Attendance Form Load Complete.'); ?>

    <!--Holiday Security Attendance Form Ends-->
