...
if(isset($_POST["submit"]))
    {
        ...
        {   
                ...
                $sql = "insert into master(catergory,date1,Name,Department,Signature,In_Time,Purpose,Token_Number) values('$cat','$date','$name','$DE','$image','$OT','$P','$Token');";
                ...
                if(mysqli_query($conn,$sql))
                    {
                        ...
                        $alert[]= $msg;
                        $alert[]= $msg2;
                        logEvent('----Out Source Third Party Movement Form Session Over---');
                    }
                else{
...
<head>
    <meta charset="utf-8">
	<title>Out Source Third Party Movement Form</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
<div class = "main"><hr>
    <?php logEvent('----Out Source Third Party Movement Form Session Started---'); ?>
    <h1><b><i>Out Source Third Party Movement Form</i></b></h1><hr>

    <div class = "error" padding-bottom = "5px"><?php foreach($alert as $a) {echo "--> ".$a."<br>";}?></div>
    <?php logEvent('Form Loading'); ?>
    <form method = "POST" action = "out_source_third_party_movement.php" autocomplete="off">
    <table>
    ...
    <tr><td>Out Time: </td><td> <input type="Time" name="In_Time" value = "<?php echo $curr_time; ?>" /></td></tr>
    <tr>
    ...
    <?php logEvent('Out Source Third Party Movement Form Load Complete.'); ?>

    <!--Out Source Third Party Movement Form Ends-->
