                ...
                if(mysqli_query($conn,$sql))
                    {
                        ...
                        $alert[]= $msg;
                        $alert[]= $msg2;
                        logEvent('----Material Outward Nonreturnable Form Session Over---');
                    }
                else{
...
<head>
    <meta charset="utf-8">
	<title>Material Outward Nonreturnable Form</title>
...
<body>
<div class = "main"><hr>
     <?php logEvent('----Material Outward Form Session Started---'); ?>
     <h1><b><i>Material Outward Nonreturnable Form</i></b></h1><hr>

     <div class = "error" padding-bottom = "5px"><?php foreach($alert as $a) {echo "--> ".$a."<br>";}?></div>
    <?php logEvent('Form Loading'); ?>

    <form method = "POST" action = "material_outward_nr.php" id="myform" autocomplete="off" >
    ...
    <tr><td align = "center"><input type = "submit" name ="submit"/></td><td><input type = "reset" name = "reset"/><td><a href = "index.php"><input type = "button" name = "back" value = "Back"/></a></td></tr>
     ...
     <?php logEvent('Material Outward Nonreturnable Form Load Complete.'); ?>

    <!--Material Outward Nonreturnable Form Ends-->
