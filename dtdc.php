...
<head>
    <meta charset="utf-8">
	<title>DTDC Courier Material Outward Form</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
<div class = "main"><hr>
    <?php logEvent('----DTDC Courier Form Session Started---'); ?>
    <h1><b><i>DTDC Courier Material Outward Form</i></b></h1><hr>

     <div class = "error" padding-bottom = "5px"><?php foreach($alert as $a) {echo "--> ".$a."<br>";}?></div>
    <?php logEvent('Form Loading'); ?>
    <form method = "POST" action = "dtdc.php" autocomplete="off">
    <table>
    ...
    <?php logEvent('DTDC Courier Form Load Complete.'); ?>

    <!--DTDC Courier Form Ends-->
