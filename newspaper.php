...
if(isset($_POST["submit"]))
    {
        ...
        if(count($alert)==0)
        {
                ...
                $sql = "insert into master(catergory,date1,In_Time,Newspaper,Reciver_Signature,Security_Signature,Remarks) values('$cat','$date','$IT','$news','$image','$Security_Signature','$Remarks');";
...
<body>
<div class = "main"><hr>
    <?php logEvent('----Newspaper Form Session Started---'); ?>
    <h1><b><i>Newspaper Form</i></b></h1>


    <div class = "error" padding-bottom = "5px"><?php foreach($alert as $a) {echo "--> ".$a."<br>";}?></div>
    <?php logEvent('Form Loading'); ?>
    <form method = "POST" action = "newspaper.php" autocomplete="off" >
    <table>
    ...
    <!--tr><td>Newspaper: </td><td> <input type="text" name="Newspaper" /></td></tr-->
    <tr><td>Newspaper: </td><td> <select name = "Newspaper">
   ...
   <tr>
    ...
    <?php logEvent('Newspaper Form Load Complete.'); ?>
